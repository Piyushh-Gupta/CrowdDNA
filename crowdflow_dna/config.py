...
SECURITY_MIN_CERTIFICATION_SCORE = 95
SECURITY_ALLOWED_LICENSES = ("MIT", "Apache-2.0", "BSD-3-Clause", "Python-2.0")
SECURITY_MAX_DEPENDENCY_CVSS = 7.0
SECURITY_ALLOWED_TLS_VERSIONS = ("TLSv1.2", "TLSv1.3")
SECURITY_SECRET_SCAN_ENABLED = True
SECURITY_SCAN_CACHE_TTL = 3600
SECURITY_ALLOWED_CSP_POLICIES = ("default-src 'self'",)
SECURITY_REQUIRED_HEADERS = ("Strict-Transport-Security", "X-Content-Type-Options", "X-Frame-Options")
SECURITY_MAX_FINDINGS_PER_REPORT = 1000